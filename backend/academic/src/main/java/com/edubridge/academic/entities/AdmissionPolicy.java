...
@Entity
@Table(name = "admission_policies", schema = "academic")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AdmissionPolicy extends AuditableEntity {
    ...
    private String policyType; // ADMISSION, ELIGIBILITY, VALIDATION, ASSESSMENT, COUNTRY, PROGRAM
