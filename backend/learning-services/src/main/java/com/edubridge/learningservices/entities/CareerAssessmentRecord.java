...
@Entity
@Table(name = "career_assessment_records", schema = "learning_services")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class CareerAssessmentRecord extends AuditableEntity {
    ...
    private String assessmentType; // CAREER_READINESS, PROFESSIONAL_COMPETENCY, LEADERSHIP, INDUSTRY_ALIGNMENT, INTERVIEW_PREP
    ...
    private String assessmentDomain; // CAREER, PROFESSIONAL, LEADERSHIP, INDUSTRY, ENTREPRENEURSHIP
