# ADR-112: Observability-First, Compatibility-Aware, and Standards-Based Domain Observability Framework
...
- Domain Documentation Foundations (ADR-108) — Documentation standards inform observability standards
- Platform Architecture Foundations (ADR-109) — Platform standards inform observability standards
- Domain Compliance Foundations (ADR-110) — Compliance standards inform observability standards
- Domain Quality Assurance Foundations (ADR-111) — Quality standards inform observability standards
